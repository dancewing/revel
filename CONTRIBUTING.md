...
* [GitHub Issues](https://github.com/dancewing/revel/issues)
...
```
$ go get github.com/dancewing/revel                        # Install Revel
$ cd $GOPATH/src/github.com/dancewing/revel                # Change directory to revel repo
...
```
$ go test github.com/dancewing/revel
```

Refer to the
[Travis configuration](https://github.com/dancewing/revel/blob/master/.travis.yml)
...
[issues](https://github.com/dancewing/revel/issues?labels=contributor+ready&page=1&state=open).
