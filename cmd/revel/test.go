...
import (
	...
	"github.com/dancewing/revel/modules/testrunner/app/controllers"
...
For example, to run the booking sample application's tests:
    ...
    revel test github.com/dancewing/examples/booking dev
...
func checkTestRunner() {
	...
	for _, module := range revel.Modules {
		if module.ImportPath == revel.Config.StringDefault("module.testrunner", "github.com/dancewing/revel/modules/testrunner") {
