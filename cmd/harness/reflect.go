...
type SourceInfo struct {
	...
	//    e.g. "github.com/dancewing/examples/chat/app/controllers.(*Application).Action"
...
type TypeInfo struct {
	...
	ImportPath  string // e.g. "github.com/dancewing/examples/chat/app/controllers"
...
// e.g. "github.com/dancewing/revel.Controller"
